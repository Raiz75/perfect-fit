<aside class="adminSidebar" id="adminSidebar">
    ...
    <div class="sidebarFooter">
        <button type="button" class="sidebarLink logoutLink" onclick="document.getElementById('adminSidebar').classList.remove('mobileOpen');document.getElementById('sidebarOverlay').classList.remove('show');document.getElementById('logoutModal').classList.add('show')">
