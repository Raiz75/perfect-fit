...
<head>
    ...
    <style>
        ...
        .float-img:nth-child(1) { width: 700px; height: 500px; top: 10%; right: 5%; animation-delay: 0s; }
...
<body>
    ...
    <main>
        <section class="relative min-h-screen flex flex-col lg:flex-row items-start px-6 lg:px-16 pt-24 pb-12 overflow-hidden bg-cover bg-center" style="background-image: url('{{ asset('images/banner.png') }}')">
            ...
            <div class="flex flex-col items-center text-center max-w-xl relative z-10 mt-16 lg:mt-32 lg:w-1/2 lg:ml-18 xl:ml-34">
                <h1 class="text-6xl sm:text-7xl font-extrabold leading-[1.05] mb-4 text-white">
                    PERFIT
                </h1>
                <p class="text-base sm:text-lg text-slate-400 leading-relaxed mb-10 max-w-md">
